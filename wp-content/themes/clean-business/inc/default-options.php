...
function clean_business_get_default_theme_options( $parameter = null ) {
	...
	$default_theme_options = array(
		...
		'featured_content_bg_image'                        => get_template_directory_uri() . '/images/default_bg.jpg',
...
function clean_business_color_schemes() {
	$options= array(
		'light'    => array(
			'value'=> 'light',
			'label'=> esc_html__( 'Light', 'clean-business' ),
		),
		'dark'     => array(
			'value'=> 'dark',
			'label'=> esc_html__( 'Dark', 'clean-business' ),
		),
	);
...
function clean_business_enable_featured_header_image_options() {
	$options = array(
		'homepage' 		=> array(
			'value'	=> 'homepage',
			'label' => esc_html__( 'Homepage / Frontpage', 'clean-business' ),
		),
		'exclude-homepage' 		=> array(
			'value'	=> 'exclude-home',
			'label' => esc_html__( 'Excluding Homepage', 'clean-business' ),
		),
		'exclude-home-page-post' 	=> array(
			'value' => 'exclude-home-page-post',
			'label' => esc_html__( 'Excluding Homepage, Page/Post Featured Image', 'clean-business' ),
		),
		'entire-site' 	=> array(
			'value' => 'entire-site',
			'label' => esc_html__( 'Entire Site', 'clean-business' ),
		),
		'entire-site-page-post' 	=> array(
			'value' => 'entire-site-page-post',
			'label' => esc_html__( 'Entire Site, Page/Post Featured Image', 'clean-business' ),
		),
		'pages-posts' 	=> array(
			'value' => 'pages-posts',
			'label' => esc_html__( 'Pages and Posts', 'clean-business' ),
		),
		'disabled'		=> array(
			'value' => 'disabled',
			'label' => esc_html__( 'Disabled', 'clean-business' ),
		),
	);
...
function clean_business_get_archive_content_layout() {
	$options = array(
		'excerpt-image-left' => array(
			...
			'label' => esc_html__( 'Excerpt Image Left', 'clean-business' ),
		),
		'excerpt-image-right' => array(
			'value' => 'excerpt-image-right',
			'label' => esc_html__( 'Excerpt Image Right', 'clean-business' ),
		),
		'excerpt-image-top' => array(
			'value' => 'excerpt-image-top',
			'label' => esc_html__( 'Excerpt Image Top', 'clean-business' ),
		),
		'full-content' => array(
			'value' => 'full-content',
			'label' => esc_html__( 'Show Full Content (No Featured Image)', 'clean-business' ),
		),
	);
...
function clean_business_get_pagination_types() {
	$options = array(
		'default' => array(
			'value' => 'default',
			'label' => esc_html__( 'Default(Older Posts/Newer Posts)', 'clean-business' ),
		),
		'numeric' => array(
			'value' => 'numeric',
			'label' => esc_html__( 'Numeric', 'clean-business' ),
		),
		'infinite-scroll-click' => array(
			'value' => 'infinite-scroll-click',
			'label' => esc_html__( 'Infinite Scroll (Click)', 'clean-business' ),
		),
		'infinite-scroll-scroll' => array(
			'value' => 'infinite-scroll-scroll',
			'label' => esc_html__( 'Infinite Scroll (Scroll)', 'clean-business' ),
		),
	);
...
function clean_business_featured_content_layout_options() {
	$options = array(
		'layout-one' 	=> array(
			'value' => 'layout-one',
			'label' => esc_html__( '1 column', 'clean-business' ),
		),
		'layout-two' 	=> array(
			'value' => 'layout-two',
			'label' => esc_html__( '2 columns', 'clean-business' ),
		),
		'layout-three' 	=> array(
			'value' => 'layout-three',
			'label' => esc_html__( '3 columns', 'clean-business' ),
		),
		'layout-four' 	=> array(
			'value' => 'layout-four',
			'label' => esc_html__( '4 columns', 'clean-business' ),
		)
	);
...
function clean_business_featured_content_types() {
	$options = array(
		'demo-featured-content' => array(
			...
			'label' => esc_html__( 'Demo Featured Content', 'clean-business' ),
		),
		'featured-page-content' => array(
			'value' => 'featured-page-content',
			'label' => esc_html__( 'Featured Page Content', 'clean-business' ),
		),
	);
...
function clean_business_featured_slider_types() {
	$options = array(
		'demo-featured-slider' => array(
			...
			'label' => esc_html__( 'Demo Featured Slider', 'clean-business' ),
		),
		'featured-page-slider' => array(
			'value' => 'featured-page-slider',
			'label' => esc_html__( 'Featured Page Slider', 'clean-business' ),
		)
	);
...
function clean_business_featured_slider_transition_effects() {
	$options = array(
		'fade' 		=> array(
			'value'	=> 'fade',
			'label' => esc_html__( 'Fade', 'clean-business' ),
		),
		'slide'	=> array(
			'value' => 'slide',
			'label' => esc_html__( 'Slide', 'clean-business' ),
		)
	);
...
function clean_business_get_content() {
	...
	$content['left'] 	= sprintf( _x( 'Copyright &copy; %1$s %2$s. All Rights Reserved.', '1: Year, 2: Site Title with home URL', 'clean-business' ), date( 'Y' ), '<a href="'. esc_url( home_url( '/' ) ) .'">'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '</a>' );
