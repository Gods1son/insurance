			...
			$clean_business_featured_slider = '
				<div id="slideshow" class="header-slider '. esc_attr( $slider_select ) .'" data-speed="'. esc_attr( $speed * 1000 ) .'" data-fx="'. esc_attr( $transition_effect ) .'">
					<div class="slides-container">';
						// Select Slider
						if ( $slider_select == 'demo-featured-slider' ) {
							$clean_business_featured_slider .=  clean_business_demo_slider();
						}
						else if ( $slider_select == 'featured-post-slider' || $slider_select == 'featured-page-slider' || $slider_select == 'featured-category-slider' ) {
...
function clean_business_demo_slider() {
	return '
		<div class="slide-item" style="background-image:url(\''. get_template_directory_uri() .'/images/gallery/slider1-1920x1080.jpg\')">
	    ...
	    <div class="slide-item" style="background-image:url(\''. get_template_directory_uri() .'/images/gallery/slider2-1920x1080.jpg\')">
			<div class="slide-inner">
	            <div class="contain animated fadeInRightBig text-slider">
...
function clean_business_post_page_category_slider() {
	...
	while ( $get_featured_posts->have_posts() ) {
		...
		$image = get_template_directory_uri().'/images/gallery/no-featured-image-1920x800.jpg';
