...
$clean_business_featured_slider_content_options = clean_business_featured_slider_content_options();
$choices = array();
foreach ( $clean_business_featured_slider_content_options as $clean_business_featured_slider_content_option ) {
	$choices[$clean_business_featured_slider_content_option['value']] = $clean_business_featured_slider_content_option['label'];
}
...
$clean_business_featured_content_layout_options = clean_business_featured_content_layout_options();
$choices = array();
foreach ( $clean_business_featured_content_layout_options as $clean_business_featured_content_layout_option ) {
	$choices[$clean_business_featured_content_layout_option['value']] = $clean_business_featured_content_layout_option['label'];
}
...
$clean_business_featured_content_types = clean_business_featured_content_types();
$choices = array();
foreach ( $clean_business_featured_content_types as $clean_business_featured_content_type ) {
	$choices[$clean_business_featured_content_type['value']] = $clean_business_featured_content_type['label'];
}
