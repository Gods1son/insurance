 ...
 * @since Clean Business 0.1
 */
function clean_business_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Clean Business 0.1
 */
function clean_business_sanitize_custom_css( $input ) {
	if ( $input != '' ) {
 ...
 */
function clean_business_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Clean Business 0.1
 */
function clean_business_sanitize_page( $input ) {
 ...
 * @since Clean Business 0.1
 */
function clean_business_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function clean_business_sanitize_number_range( $number, $setting ) {
	// Ensure input is an absolute integer.
 ...
 *
 * @see clean_business_sanitize_select()               https://developer.wordpress.org/reference/functions/clean_business_sanitize_select/
 ...
 */
function clean_business_sanitize_select( $input, $setting ) {
 ...
 * @since Clean Business 0.1
 */
function clean_business_reset_all_settings( $input ) {
	if ( $input == 1 ) {
        // Remove all theme mod values
        remove_theme_mods();
 ...
 *
 * @since Clean Business 1.2
 */
function clean_business_sanitize_important_link() {
	return false;
}
