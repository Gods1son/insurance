...
function clean_business_customize_register( $wp_customize ) {
	...
	$schemes = clean_business_color_schemes();
	...
	require get_template_directory() . '/inc/customizer-includes/featured-content.php';

	//Featured Slider
	require get_template_directory() . '/inc/customizer-includes/featured-slider.php';

	//Social Links
	require get_template_directory() . '/inc/customizer-includes/social-icons.php';
	...
	$wp_customize->add_setting( 'reset_all_settings', array(
		...
		'sanitize_callback' => 'clean_business_reset_all_settings',
...
function clean_business_customize_preview() {
	wp_enqueue_script( 'clean_business_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20120827', true );
...
function clean_business_customize_scripts() {
	wp_enqueue_script( 'clean_business_customizer_custom', get_template_directory_uri() . '/js/customizer-custom-script.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20160620', true );
...
require get_template_directory() . '/inc/customizer-includes/upgrade-button/class-customize.php';
