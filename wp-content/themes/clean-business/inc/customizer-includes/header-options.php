...
$clean_business_enable_featured_header_image_options = clean_business_enable_featured_header_image_options();
$choices = array();
foreach ( $clean_business_enable_featured_header_image_options as $clean_business_enable_featured_header_image_option ) {
	$choices[$clean_business_enable_featured_header_image_option['value']] = $clean_business_enable_featured_header_image_option['label'];
}
