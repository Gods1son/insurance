	    ...
	    <div id="clean-business-ui-tabs" class="ui-tabs">
		    ...
		    <div id="frag4" class="catch_ad_tabhead">
		    	<table id="featured-image-metabox" class="form-table" width="100%">
		            <tbody>
		                <tr>
		                     <select name="clean-business-header-image" id="custom_element_grid_class">
			                     <?php
...
function clean_business_enqueue_metabox_scripts() {
    //Scripts
	wp_enqueue_script( 'clean-business-metabox-js', get_template_directory_uri() . '/js/metabox.js', array( 'jquery', 'jquery-ui-tabs' ), '2013-10-05' );

	//CSS Styles
	wp_enqueue_style( 'clean-business-metabox-css', get_template_directory_uri() . '/css/metabox.css' );
}
