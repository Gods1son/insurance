...
use Kirki\Controls\PromoControl;
...
class Controls {
	...
	public function register_control_type( $wp_customize ) {
		...
		$wp_customize->register_control_type( '\Kirki\Controls\PromoControl' );
	...
	public function add( $wp_customize, $field ) {
		...
		switch ( $field['type'] ) {
			...
			case 'promo' :
				$wp_customize->add_control( new PromoControl( $wp_customize, $field['id'], $field ) );
				break;
