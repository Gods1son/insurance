...
function amazing_blog_admin_scripts() {
	wp_enqueue_script( 'amazing-blog-admin-panel-js', get_template_directory_uri() . '/assets/js/admin-panel.js', array(), '' );
	wp_enqueue_style( 'amazing-blog-admin-section-css', get_template_directory_uri() . '/assets/css/admin-section.css', array(), '' );
	}
add_action( 'admin_enqueue_scripts', 'amazing_blog_admin_scripts' );
