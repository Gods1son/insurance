 ...
 */
function skyhead_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'skyhead_customize_register' );
 ...
 * @since 1.0.0
 */
function skyhead_customize_preview_js() {

	wp_enqueue_script( 'skyhead_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );

}
add_action( 'customize_preview_init', 'skyhead_customize_preview_js' );
