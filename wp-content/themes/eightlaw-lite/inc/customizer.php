...
function eightlaw_lite_customize_register( $wp_customize ) {
  ...
  $wp_customize->get_section('static_front_page')->panel = 'eightlaw_lite_default_setting'; //priority 120
   ...
   $wp_customize->add_control('eightlaw_lite_webpage_layout', array(
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'eightlaw_lite_logo_upload', array(
		'label' => __('Upload logo for your site', 'eightlaw-lite'),
		'section' => 'eightlaw_lite_logo_setting',
		'setting' => 'eightlaw_lite_logo_upload'
	)));
   ...
   $wp_customize->add_panel('eightlaw_lite_homepage_settings', array(
      'capabitity' => 'edit_theme_options',
      'priority' => 30,
      'title' => __('Homepage Settings', 'eightlaw-lite')
   ));
...
//homepage Client Logo section
   ...
   $wp_customize->add_control('eightlaw_lite_clientlogo_setting_option', array(
      ...
      'section' => 'eightlaw_lite_clientlogo_section',
...
//Gallery Section for slider
  ...
  //Gallery Title
   ...
   $wp_customize->add_control( new Eightlaw_lite_Customize_Category_Control( $wp_customize,'eightlaw_lite_blog_setting_category', array(
    ...
    //read more text for blogs
   $wp_customize->add_setting('eightlaw_lite_blog_single_readmore', array(
    'default' => __('View More','eightlaw-lite'),
        'sanitize_callback' => 'eightlaw_lite_sanitize_text',
        'transport' => 'postMessage'
  ));

    $wp_customize->add_control('eightlaw_lite_blog_single_readmore',array(
        'type' => 'text',
        'label' => __('Details','eightlaw-lite'),
        'section' => 'eightlaw_lite_blog_section',
        'setting' => 'eightlaw_lite_blog_single_readmore'
    ));
   ...
   $wp_customize->add_control('eightlaw_lite_benefit_setting_option', array(
      ...
      'section' => 'eightlaw_lite_benefit_section',
   ...
   $wp_customize->add_control('eightlaw_lite_testimonial_setting_option', array(
      ...
      'section' => 'eightlaw_lite_testimonial_section',
   ...
   $wp_customize->add_control('eightlaw_lite_latestpost_setting_option', array(
      ...
      'section' => 'eightlaw_lite_latestpost_section',
   ...
   $wp_customize->add_control('eightlaw_lite_latestnews_setting_option', array(
      ...
      'section' => 'eightlaw_lite_latestnews_section',
...
//select category for latest news
   ...
   $wp_customize->add_setting('eightlaw_lite_social_rss', array(
    ...
    $wp_customize->add_panel('eightlaw_lite_archive_setting', array(
      'capabitity' => 'edit_theme_options',
      'priority' => 70,
      'title' => __('Archive Page Settings', 'eightlaw-lite')
   ));
   ...
   //Archive page testimonial list readmore text
   $wp_customize->add_setting('eightlaw_lite_archive_setting_testimonial_readmore', array(
		'default' => __('Read More','eightlaw-lite'),
        'sanitize_callback' => 'eightlaw_lite_sanitize_text',
	));

    $wp_customize->add_control('eightlaw_lite_archive_setting_testimonial_readmore',array(
        'type' => 'text',
        'label' => __('Read More Text for Testimonial list','eightlaw-lite'),
        'section' => 'eightlaw_lite_archive_setting_testimonial',
        'setting' => 'eightlaw_lite_archive_setting_testimonial_readmore'
    ));
   ...
   //Archive page blog list readmore text
   $wp_customize->add_setting('eightlaw_lite_archive_setting_blog_readmore', array(
    'default' => __('Read More','eightlaw-lite'),
        'sanitize_callback' => 'eightlaw_lite_sanitize_text',
  ));

    $wp_customize->add_control('eightlaw_lite_archive_setting_blog_readmore',array(
        'type' => 'text',
        'label' => __('Read More Text for Blog list','eightlaw-lite'),
        'section' => 'eightlaw_lite_archive_setting_blog',
        'setting' => 'eightlaw_lite_archive_setting_blog_readmore'
    ));
    //Archive Page Settings section : Archive
   ...
   //Archive page teammember list readmore text
   $wp_customize->add_setting('eightlaw_lite_archive_setting_teammember_readmore', array(
		'default' => __('Read More','eightlaw-lite'),
        'sanitize_callback' => 'eightlaw_lite_sanitize_text',
	));

    $wp_customize->add_control('eightlaw_lite_archive_setting_teammember_readmore',array(
        'type' => 'text',
        'label' => __('Read More Text for Team Member','eightlaw-lite'),
        'section' => 'eightlaw_lite_archive_setting_teammember',
        'setting' => 'eightlaw_lite_archive_setting_teammember_readmore'
    ));
   ...
   // Banner setting
    ...
    $wp_customize -> add_section(
        ...
        array(
            'title' => __('Category Banner Image','eightlaw-lite'),
            'priority' => 20,
            'panel' => 'eightlaw_lite_single_setting',
        )
    );
