...
?>
    <div class="section-wrapper">
        <a href="#"><?php dynamic_sidebar( 'widget_icon' );?></a>
    </div>
<?php
endif;
           ...
           <?php
                ...
                ?><div class="blog-in-wrap">
                    <div class="blog-image">
                        ...
                        <span class="blog-date"><a href="<?php echo esc_url(get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html(get_the_date('d M')); ?></a></span>
                    </div>
                    <div class="blog-content-wrap">
                        <div class="blog-title-comment">
                            <div class="blog-single-title"><a href="<?php the_permalink();?>"><?php the_title(); ?></a></div>
                        ...
                        <div class="blog-content"><?php echo eightlaw_lite_excerpt(get_the_content(), 250); ?>
                        <div class="btn"><a href="<?php the_permalink() ?>"><?php echo esc_html(get_theme_mod('eightlaw_lite_blog_single_readmore',__('View More','eightlaw-lite'))); ?></a></div>
                        </div>
                    </div>
                  </div>
                <?php
                        ...
                        <div class="lp-wrap">
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                ...
                                <div class="entry-content clearfix">
                                    ...
                                    <?php echo eightlaw_lite_excerpt( get_the_excerpt() , 150 ); ?>
                                    </div>
                ...
                <div class="ln-slider">
                    ...
                    if(has_post_thumbnail()){
                        $image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),'medium');
                              ?>
                              <div class="news-image"><a href="the_permalink();"><img src="<?php echo esc_url($image[0]); ?>" alt="<?php the_title_attribute(); ?>" /></a></div>
                            <?php
